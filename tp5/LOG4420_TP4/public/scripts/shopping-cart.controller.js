...
(function($, shoppingCartService, utils) {
  ...
  $("#add-to-cart-form").submit(function(event) {
    ...
    shoppingCartService.addItem(productId, +$(this).find("input").val()).done(function() {
      var dialog = $("#dialog");
      dialog.fadeIn();
      setTimeout(function() {
        dialog.fadeOut();
      ...
      _updateCount();
      shoppingCartService.getItemQuantity(productId).done(function(quantity) {
  ...
  $(".shopping-cart-table > tbody >  tr").each(function() {
    var rowElement = $(this);
    var productId = +rowElement.attr("data-product-id");
    ...
    function updateQuantity(quantity) {
      ...
      shoppingCartService.getItem(productId).done(function(item) {
